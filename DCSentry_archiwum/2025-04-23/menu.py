...
def display_menu():
    """
    Display the main menu options for the DC Sentry app.
    """
    print()
...
def handle_choice(choice):
    """
    Handle the user's menu choice and call the corresponding function.
...
def main():
    """
    Initialize the database and display the main menu in a loop until the user exits.
    """
    initialize_db()
